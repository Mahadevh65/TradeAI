...
export default function Sidebar() {
  ...
  const navItems = isLoggedIn ? PRIVATE_NAV_ITEMS : PUBLIC_NAV_ITEMS
        ...
        {isLoggedIn ? (
          ...
          <>
            <div className="flex items-center gap-2.5 px-2 mb-4">
              ...
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-signal-violet to-signal-cyan flex items-center justify-center text-sm font-bold text-white">
                {(user?.fullName || 'T')[0].toUpperCase()}
              </div>
            ...
            <button
              onClick={logout}
              className="w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-slate-400 hover:text-red-400 hover:bg-red-500/10 transition-colors"
            >
              <FiLogOut />
              Sign Out
            </button>
          ...
          <div className="space-y-2">
            ...
            <NavLink
              to="/login"
              className="flex items-center justify-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium bg-signal-blue text-white hover:opacity-90 transition"
            >
              <FiLogIn />
              Login
            </NavLink>
            ...
            <NavLink
              to="/register"
              className="flex items-center justify-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium border border-signal-blue text-signal-blue hover:bg-signal-blue/10 transition"
            >
              <FiUserPlus />
              Register
            </NavLink>
